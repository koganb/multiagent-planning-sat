    ...
    def "test failed clauses calculation"(
        ...
        expectedClauses << [
                ...
                [
                        ...
                        "{Index:10, Agent:satellite1,Action:turn_to~satellite1~phenomenon14~phenomenon12=FAILED}=false,{Stage:10, State:pointing~satellite1=LOCKED_FOR_UPDATE}=true,{Stage:10, State:pointing~satellite1=phenomenon12}=false,{Stage:11, State:pointing~satellite1=phenomenon12}=true",
                ...
                [
                        ...
                        "{Index:50, Agent:satellite1,Action:turn_to~satellite1~planet22~phenomenon21=FAILED}=false,{Stage:50, State:pointing~satellite1=LOCKED_FOR_UPDATE}=true,{Stage:50, State:pointing~satellite1=phenomenon21}=false,{Stage:51, State:pointing~satellite1=phenomenon21}=true",
                ...
                [
                        ...
                        "{Index:60, Agent:satellite1,Action:switch_off~instrument13~satellite1=FAILED}=false,{Stage:60, State:power_avail~satellite1=LOCKED_FOR_UPDATE}=true,{Stage:60, State:power_on~instrument13=LOCKED_FOR_UPDATE}=true,{Stage:60, State:power_on~instrument13=true}=false,{Stage:61, State:power_on~instrument13=true}=true",
