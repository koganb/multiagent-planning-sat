...
class TestNoEffectsFailureModelNoRetries extends Specification {
    ...
    static {
        ...
        log = LoggerFactory.getLogger(TestNoEffectsFailureModelNoRetries.class)
    }
    ...
    def "test diagnostics calculation for plan: #problemName, failures: #failedActions "(
        ...
        [problemName, plan, cnfPlanClauses, failedActions] <<
                [[problemArr, planArr, cnfPlanClausesArr].transpose(), [1, 2, 3, 4]]
                        ...
                        .collect {
                    [it, PreparedTestActionReader.getTestActions(it[0], it[3], "NoEffectsFailureModelNoRetriesParams")]
                }
                .collect {
